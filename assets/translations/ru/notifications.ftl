ntf-error =
    ...
    .network = ⚠️ <i>Сервис временно недоступен. Попробуйте ещё раз через минуту.</i>
...
ntf-partner =
    .payout-confirmed =
        ✅ <b>Партнёр подтвердил получение</b>

        { $name } подтвердил, что деньги дошли.
    .earning =
        💰 <b>Начисление { $amount } ₽</b>
