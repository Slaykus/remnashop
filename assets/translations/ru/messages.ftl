...
msg-menu-proxy =
    📡 <b>Поделиться прокси</b>

    Если у кого-то из друзей заблокирован Telegram — отправь им эту ссылку.
    Они смогут войти без VPN-приложений, одним нажатием.

    • <b>Отправить в Telegram</b> — если у них уже есть доступ (через другой прокси или VPN)
    • <b>Другой мессенджер</b> — скопируй ссылку и отправь через WhatsApp, Viber, SMS
