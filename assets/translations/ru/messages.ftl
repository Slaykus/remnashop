...
msg-main-menu =
    ...
    *[NONE]
    ...
    <i>{ $trial_available ->
    [1] <e id="5431744001361352063">🎁</e> Для вас доступен бесплатный пробник — нажмите кнопку ниже, чтобы его получить.
...
msg-menu-devices =
    <b><e id="5433608163196706522">📱</e> Управление устройствами</b>
...
msg-menu-devices-confirm-reissue =
    <e id="5431450139698962745">🔄</e> <b>Перевыпуск подписки</b>

    <e id="5431713747611722012">⚠️</e> После сброса старая ссылка <b>перестанет работать</b> и все устройства придется заново переподключать.
...
msg-menu-devices-confirm-delete =
    <e id="5433693255088776864">🗑</e> <b>Подтвердите удаление устройства</b>
...
msg-menu-devices-confirm-delete-all =
    <e id="5433693255088776864">🗑</e> <b>Подтвердите удаление всех устройств</b>

msg-menu-invite =
    <b><e id="5434067728992347183">👥</e> Пригласить друзей</b>
    ...
    <b><e id="5431409921625205825">📊</e> Статистика</b>:
    <blockquote>
    <e id="5434067728992347183">👥</e> Всего приглашенных: { $referrals }
    <e id="5431887891355703774">💳</e> Платежей по вашей ссылке: { $payments }
    { $reward_type -> 
    [POINTS] <e id="5431658449907789518">💎</e> Ваши баллы: { $points }
    *[EXTRA_DAYS] { empty }
    }
    </blockquote>

msg-menu-invite-about =
    <b><e id="5431744001361352063">🎁</e> Подробнее о вознаграждении</b>

    <b><e id="5431673473703389665">✨</e> Как получить награду</b>:
    <blockquote>
    { $accrual_strategy ->
    ...
    *[OTHER] { $accrual_strategy }
    ...
    <b><e id="5431658449907789518">💎</e> Что вы получаете</b>:
    <blockquote>
    { $max_level -> 
...
msg-subscription-plans = <b><e id="5431887363074728345">📦</e> Выберите план</b>
...
msg-subscription-plan = 
    <b><e id="5431887363074728345">📦</e> Доступный план по ссылке</b>
    ...
    *[HAS]
    ...
    { $purchase_type ->
    [RENEW] <i><e id="5431713747611722012">⚠️</e> Текущая подписка будет <u>продлена</u> на выбранный срок.</i>
    [CHANGE] <i><e id="5431713747611722012">⚠️</e> Текущая подписка будет <u>заменена</u> данным планом без пересчета оставшегося срока.</i>
    *[OTHER] { empty }
    }
...
msg-subscription-payment-method =
    <b><e id="5433625699548179370">💳</e> Выберите способ оплаты</b>
...
msg-subscription-confirm =
    <b><e id="5433718990532814817">🛒</e> Подтверждение { $purchase_type ->
    [RENEW] продления
    [CHANGE] изменения
    *[OTHER] покупки
    } подписки</b>
    ...
    { $purchase_type ->
    [RENEW] <i><e id="5431713747611722012">⚠️</e> Текущая подписка будет <u>продлена</u> на выбранный срок.</i>
    [CHANGE] <i><e id="5431713747611722012">⚠️</e> Текущая подписка будет <u>заменена</u> выбранной без пересчета оставшегося срока.</i>
    *[OTHER] { empty }
    }
...
msg-subscription-trial =
    <b><e id="5433838236004820271">✅</e> Пробная подписка успешно получена!</b>

    { msg-subscription-new-success }

msg-subscription-success =
    <b><e id="5433838236004820271">✅</e> Оплата прошла успешно!</b>
...
msg-subscription-failed = 
    <b><e id="5433773811495378237">❌</e> Произошла ошибка!</b>
...
msg-promocode-input =
    <b><e id="5431503878329774916">🎟</e> Промокод</b>

    Введите промокод.

msg-promocode-confirm =
    <b><e id="5431503878329774916">🎟</e> Промокод <code>{ $promo_code }</code></b>

    <e id="5431744001361352063">🎁</e> Вы получите: { $reward_type ->
        [DURATION] { $reward ->
    ...
    { $show_reset_warning ->
        [1] <e id="5431713747611722012">⚠️</e> <i>Бонус действует до следующего продления подписки — при продлении лимит вернется к значению плана.</i>
       *[0] { space }
    }
    { $will_replace_subscription ->
        [1] <e id="5431713747611722012">⚠️</e> <i>У вас уже есть активная подписка. Она будет заменена новым планом, текущий остаток дней и трафик будут сброшены.</i>
       *[0] { space }
    }
...
msg-advertising-partners =
    ...
    Партнёрская ссылка — это рекламная ссылка с владельцем. Условия у
    каждого свои, начисления идут со всех платежей приведённых им людей.

    <blockquote>
    • <b>Всего партнёров</b>: { $count }
    </blockquote>
...
msg-advertising-partner-view =
    ...
    <blockquote>
    • <b>Ставка</b>: { $rate_pct }%
    • <b>Удержание</b>: { $hold_days } дн.
    • <b>Минимальная выплата</b>: { $min_payout } ₽
    • <b>Состояние</b>: { $is_active ->
    [true] активен
    *[false] отключён
    }
    </blockquote>
    ...
    <blockquote>
    • <b>Ждёт срока</b>: { $pending } ₽
    • <b>Доступно к выплате</b>: { $available } ₽
    • <b>Выплачено</b>: { $paid } ₽
    • <b>Начислено всего</b>: { $total } ₽
    • <b>Учтено платежей</b>: { $payments_count }
    </blockquote>

msg-advertising-partner-add =
    <b>🤝 Новый партнёр</b>

    Пришлите telegram id человека. Он должен быть знаком боту — то есть
    хотя бы раз его запускать.

    Условия проставятся по умолчанию, поменять их можно сразу после.

msg-advertising-partner-rate =
    <b>💰 Ставка партнёра</b>

    Число от 0 до 100 — доля со всех платежей приведённых им людей.

    Новая ставка действует только вперёд: уже начисленное пересчитано не
    будет.
...
msg-advertising-partner-hold =
    ...
    Нужен, чтобы возврат платежа не превращался в долг партнёра.

msg-advertising-partner-min =
    <b>💳 Минимальная выплата</b>

    Ниже этой суммы выплата не оформляется: мелкие переводы обходятся
    дороже, чем стоят.

msg-advertising-partner-links =
    <b>🔗 Ссылки партнёра { $name }</b>

    Нажатие закрепляет ссылку за партнёром или снимает закрепление.

    <blockquote>
    • ✅ — закреплена за этим партнёром
    • ▫️ — свободна
    • 🔒 — занята другим партнёром
    </blockquote>

    Снятие не трогает уже начисленное: начисления привязаны к платежу и
    партнёру, а не к ссылке.

msg-advertising-partner-bonus =
    <b>🎁 Потолок бонуса</b>

    Сколько дней партнёр вправе поставить на свою ссылку. Ноль — раздавать
    дни ему нельзя.

    Ограничение нужно потому, что бонус идёт не из его денег: без потолка
