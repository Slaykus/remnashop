...
msg-menu-invite =
    ...
    *[EXTRA_DAYS] { empty }
    ...
    • 🌩️ Туча — <b>10%</b> (3 чел.)
    • ⛈️ Шторм — <b>15%</b> (5 чел.)
    • 🌧️ Дождь — <b>25%</b> (10 чел.)
    ...
    [3] Ваш статус: ⛈️ Шторм — скидка <b>{ $personal_discount }%</b>
    *[4] Ваш статус: 🌧️ Дождь — скидка <b>{ $personal_discount }%</b>
    }
    </blockquote>
...
msg-menu-proxy =
    ...
    Если у друга заблокирован Telegram — поделитесь этой ссылкой. Одно нажатие, и Telegram снова работает. Никаких приложений устанавливать не нужно.

    • <b>Отправить в Telegram</b> — выбрать чат и отправить напрямую
    • <b>Другой мессенджер</b> — скопировать ссылку и отправить в любом мессенджере
