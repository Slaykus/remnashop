...
msg-user-node-quota =
    ...
    <blockquote>
    • <b>Нода</b>: 🇷🇺<e id="5434006396859357687">🔴</e> 4G/LTE | Не для Wi-Fi
...
msg-subscription-traffic-reset-confirm =
    <b><e id="5434006396859357687">🔴</e> Сброс трафика 4G/LTE</b>
...
ntf-node-quota =
    .reset-purchased = <e id="5433838236004820271">✅</e> <i>Счётчик трафика 4G/LTE успешно сброшен!</i>

    .reset-purchased-system =
        <e id="5431887891355703774">💳</e> <b>Платный сброс трафика 4G/LTE</b>
    ...
    .warn =
        <e id="5431713747611722012">⚠️</e> Вы использовали <b>{ $used_gb } ГБ</b> из <b>{ $limit_gb } ГБ</b> месячного лимита на сервере для 4G/LTE.

        При достижении 100% доступ к этому серверу будет ограничен до конца месяца.

    .limited =
        <e id="5431537503628730769">🚫</e> Ваш месячный лимит на сервере для 4G/LTE (<b>{ $limit_gb } ГБ</b>) исчерпан.
