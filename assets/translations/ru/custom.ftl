...
ntf-reactivation =
    .trial-unused-first =
    <e id="5431744001361352063">🎁</e> <b>Неделя не забрана</b>

    Вы завели аккаунт, но бесплатную неделю так и не включили. Она на месте — забрать можно в меню.

    .trial-unused-last =
    <e id="5433621018033823459">🌧</e> <b>Про бесплатную неделю</b>

    Всё ещё лежит. Больше напоминать не буду — если не нужно, просто не отвечайте.

    .trial-expired-offer =
    <e id="5431503878329774916">🎟</e> <b>Скидка { $discount }% на первую подписку</b>

    Пробная неделя закончилась. Если понравилось — вот { $discount }%, сгорит через { $days } дня.

    .trial-expired-last =
    <e id="5431537503628730769">⛔</e> <b>Скидка сгорит завтра</b>

    { $discount }% на первую подписку. Дальше цена обычная.

    .paid-expired-offer =
    <e id="5431503878329774916">🎟</e> <b>Подписка закончилась</b>

    Если ушли из-за чего-то конкретного — напишите в поддержку, разберёмся. А если просто забыли продлить, вот { $discount }% на возврат, { $days } дня.

    .paid-expired-last =
    <e id="5431537503628730769">⛔</e> <b>Скидка сгорит завтра</b>

    { $discount }% на продление. Потом обычная цена.
