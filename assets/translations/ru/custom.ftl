...
msg-device-addon =
    ...
    *[OK]
    ...
    <i>При продлении устройство войдёт в стоимость: +{ $monthly_rub } ₽ в месяц.</i>
...
msg-menu-devices-addon =
    ...
    [FULL]
    { "" }
    <e id="5431350621011746205">⚡</e> Свободных слотов нет. Можно добавить ещё устройство — { $next_device_price } ₽ в месяц.
    [FREE]
    { "" }
    Нужно больше устройств? Их можно добавить — { $next_device_price } ₽ в месяц за каждое.
    *[HIDE] { "!empty!" }
    }
