...
btn-menu =
    .trial = <e id="5429339305006900161">🌧️</e> ПОПРОБОВАТЬ БЕСПЛАТНО
    .trial-paid = <e id="5429339305006900161">🌧️</e> ПОПРОБОВАТЬ ЗА { $trial_price }
    .connect = <e id="5429282761762450449">⚡</e> Подключиться
    .connect-reserve = <e id="5429584264171661832">🔗</e> Подключиться (резерв)
    .devices = <e id="5429616296037753715">📱</e> Мои устройства
    .subscription = <e id="5429564215264325150">💎</e> Подписка
    .invite = <e id="5429600567867515464">👥</e> Пригласить друга
    .support = <e id="5431896318081542131">💬</e> Поддержка
    .web-cabinet = <e id="5429122254539629456">🌐</e> Личный кабинет
    .dashboard = <e id="5429161811188426323">🎛</e> Панель управления
...
btn-invite =
    .about = <e id="5429441933250439962">❓</e> Подробнее о награде
    .copy = <e id="5431552836661977123">📋</e> Скопировать ссылку
    .send = <e id="5429450274076929631">📩</e> Пригласить
    .qr = <e id="5429192215261911590">🔳</e> QR-код
    .withdraw-points = <e id="5429251773573407519">⭐</e> Обменять баллы
    .reset-referral = <e id="5429165006644095979">🔄</e> Сбросить реф. ссылку

btn-devices =
    .delete-all = <e id="5429606649541208054">🗑</e> Удалить все устройства
    .reissue = <e id="5429165006644095979">🔄</e> Перевыпустить подписку
    .confirm-delete = <e id="5431365176655913424">✅</e> Да, удалить
    .confirm-reissue = <e id="5431365176655913424">✅</e> Да, сбросить
    .cancel-reissue = <e id="5431373569022009585">❌</e> Нет

btn-subscription =
    .plan = <e id="5431866897555564066">🗂</e> Перейти к оформлению подписки
    .new = <e id="5429458988565570302">💰</e> Купить подписку
    .renew = <e id="5431470622397996981">🔁</e> Продлить
    .change = <e id="5429519899791762269">🔀</e> Изменить
    .promocode = <e id="5431674023459204413">🎟</e> Активировать промокод
    .promocode-confirm = <e id="5431365176655913424">✅</e> Подтвердить
    .pay = <e id="5429173368945420581">💳</e> Оплатить
    .get = <e id="5429103378158366023">🎁</e> Получить бесплатно
    .back-plans = <e id="5429579775930837843">⬅️</e> Назад к выбору плана
    .back-duration = <e id="5429579775930837843">⬅️</e> Изменить длительность
    .back-payment-method = <e id="5429579775930837843">⬅️</e> Изменить способ оплаты
    .connect = <e id="5429282761762450449">⚡</e> Подключиться

btn-back =
    .general = <e id="5429579775930837843">⬅️</e> Назад
    .menu = <e id="5431571386625732786">🏠</e> Главное меню
    .menu-return = <e id="5431571386625732786">🏠</e> Вернуться в главное меню

btn-common =
    .cancel = <e id="5431373569022009585">❌</e> Отмена
    .notification-close = <e id="5431373569022009585">❌</e> Закрыть

# Кастомные кнопки пользовательского меню
btn-how-connect = <e id="5431382528323788017">🧭</e> Как подключиться?
btn-proxy = 👀 Поделиться Mtproxy
btn-proxy-share = <e id="5429450274076929631">📩</e> Отправить в Telegram
btn-proxy-copy = <e id="5431552836661977123">📋</e> Скопировать ссылку
