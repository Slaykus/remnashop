...
event-referral =
    ...
    *[OTHER] { $reward_type }
    ...
    .milestone =
    { $tier ->
    [1] 🎉 <b>Новый статус: ☁️ Облако!</b>
    [2] 🎉 <b>Новый статус: 🌩️ Туча!</b>
    [3] 🎉 <b>Новый статус: ⛈️ Шторм!</b>
    [4] 🎉 <b>Новый статус: 🌧️ Дождь!</b>
    *[other] 🎉 <b>Новый статус!</b>
    }

    <blockquote>
    Вы пригласили <b>{ $paid_referrals_count } { $paid_referrals_count ->
        [one] активного пользователя
        [few] активных пользователей
        *[other] активных пользователей
    }</b> — и заработали постоянную скидку <b>{ $discount }%</b> на все подписки!
    </blockquote>
