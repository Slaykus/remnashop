...
event-subscription =
    ...
    { $is_trial ->
    [0]
    <b><e id="5431713747611722012">⚠️</e> Внимание! Ваша подписка закончится через { unit-day }.</b>
    
    Продлите ее заранее, чтобы не терять доступ к сервису! 
    *[1]
    <b><e id="5431713747611722012">⚠️</e> Внимание! Ваш бесплатный пробник закончится через { unit-day }.</b>

    Оформите подписку, чтобы не терять доступ к сервису! 
    }

    .expired =
    <b><e id="5431537503628730769">⛔</e> Внимание! Доступ приостановлен — VPN не работает.</b>
    ...
    *[1] { $traffic_strategy ->
    ...
    .not-connected =
    <b><e id="5431350621011746205">🔌</e> Не получилось подключиться?</b>
...
event-torrent-blocker =
    .user-blocked =
    <b><e id="5431537503628730769">⛔</e> Доступ на сервере временно ограничен.</b>
    ...
    <b><e id="5431713747611722012">⚠️</e> Событие: Обнаружен BitTorrent трафик!</b>
